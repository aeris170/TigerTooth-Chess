...
public class BitBoard {
	...
	enum Piece {
		...
		/**
		 * Checks if is valid tile.
		 *
		 * @param moveLocation
		 *            the move location
		 * @return true, if is valid tile
		 */
