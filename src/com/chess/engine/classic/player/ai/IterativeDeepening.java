...
public class IterativeDeepening extends Observable implements MoveStrategy {
	...
	/**
	 * Instantiates a new ýterative deepening.
	 *
	 * @param searchDepth
	 *            the search depth
	 */
	...
	public Move execute(final Board board) {
		...
		while (currentDepth <= this.searchDepth) {
			...
			System.out.println("\t" + toString() + " bestMove = " + bestMove + " Depth = " + currentDepth + " took "
					+ (subTime) + " ms, ordered moves : " + records);
			setChanged();
	...
	private static class MoveScoreRecord implements Comparable<MoveScoreRecord> {
		...
		/**
		 * Instantiates a new move score record.
		 *
		 * @param move
		 *            the move
		 * @param score
	...
	enum Ordering {
		 ...
		 * Order.
		 *
		 * @param moveScoreRecords
		 *            the move score records
		 * @return the list
		 */
	...
	private static class MoveOrderingBuilder {
		...
		/**
		 * Instantiates a new move ordering builder.
		 */
		MoveOrderingBuilder() {
