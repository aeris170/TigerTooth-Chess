...
/**
 * A tile on a chess board. As you well know there are 64 tiles.
 * 
 * @author Doða Oruç
 * @version 06.08.2017
 */
abstract public class Tile implements Serializable {
	...
	private static final long serialVersionUID = 4234408280137917811L;

	/** The tile coordinate. */
	private final int tileCoordinate;

	/** The Constant EMPTY_TILES. */
	private static final Map<Integer, EmptyTile> EMPTY_TILES = createAllPossibleEmptyTiles();

	/** The Constant OCCUPIED_TILES. */
	...
	/**
	 * Checks if is tile occupied.
	 *
	 * @return true, if is tile occupied
	 */
	...
	/**
	 * Creates the all possible empty tiles.
	 *
	 * @return the map
	 */
	...
	/**
	 * Creates the all possible occupied tiles.
	 *
	 * @return the table
	 */
	...
	private static final class EmptyTile extends Tile {
		...
		/** The Constant serialVersionUID. */
		private static final long serialVersionUID = 2280332754343963953L;
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.chess.engine.classic.board.Tile#isTileOccupied()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.chess.engine.classic.board.Tile#getPiece()
		 */
	...
	/**
	 * The Class OccupiedTile.
	 */
	private static final class OccupiedTile extends Tile {

		/** The Constant serialVersionUID. */
		private static final long serialVersionUID = 9212569862773526751L;
