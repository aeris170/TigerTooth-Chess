...
public enum BoardUtils {
	...
	/**
	 * Ýnitialize position to coordinate map.
	 *
	 * @return the map
	 */
	...
	/**
	 * Checks if is threatened board ýmmediate.
	 *
	 * @param board
	 *            the board
	 * @return true, if is threatened board ýmmediate
	 */
